...
import ap1 from "../../../../Assets/Images/AppPatrimonio/AP1.png";
import ap2 from "../../../../Assets/Images/AppPatrimonio/AP2.png";
...
class EyepImages extends Component {
  render() {
    ...
    return (
      <React.Fragment>
        <Tablet src={ap1} scroll={scrollPercent} alt="eyepTablet" />
        <Iphone src={ap2} scroll={scrollPercent} alt="eyepIphone" />
      </React.Fragment>
    );
  }
}
